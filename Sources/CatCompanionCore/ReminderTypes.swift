...
public enum AppStringKey: String {
    ...
    case diagnosticsQuickStartPetModeTitle
    case diagnosticsQuickStartPetModeDetail
...
public enum AppStrings {
    ...
    private static let zhHansTable: [AppStringKey: String] = [
        ...
        .diagnosticsGuideTitle: "首次运行诊断",
        .diagnosticsGuideSubtitle: "检测本机环境是否满足 AI 助理与语音功能。",
        ...
        .diagnosticsGuideDone: "完成",
        .diagnosticsQuickStartTitle: "快速上手（3 步）",
        .diagnosticsQuickStartNotificationsTitle: "通知权限",
        .diagnosticsQuickStartNotificationsDetail: "建议先开启系统通知，提醒会更稳定。",
        .diagnosticsQuickStartGatewayTitle: "AI 连通性",
        .diagnosticsQuickStartGatewayDetail: "点击“重新检测”，确认 Gateway 可用。",
        .diagnosticsQuickStartPetModeTitle: "宠物显示模式",
        .diagnosticsQuickStartPetModeDetail: "可在设置中选择“仅在提醒时显示猫咪”。",
        .diagnosticsStatusPass: "通过",
        .diagnosticsStatusWarning: "警告",
        .diagnosticsStatusFailed: "失败",
        .diagnosticsCheckHelper: "内置 Helper",
        .diagnosticsCheckGateway: "Gateway 地址",
        .diagnosticsCheckMicrophone: "麦克风权限",
        .diagnosticsCheckWhisperCommand: "Whisper 命令",
        .diagnosticsCheckWhisperModel: "Whisper 模型",
        .diagnosticsCheckCosyScript: "CosyVoice 脚本",
        .diagnosticsCheckPythonDependencies: "Python 语音依赖",
    ...
    private static let zhHantTable: [AppStringKey: String] = [
        ...
        .diagnosticsGuideTitle: "首次執行診斷",
        .diagnosticsGuideSubtitle: "檢查本機環境是否符合 AI 助理與語音功能需求。",
        ...
        .diagnosticsGuideDone: "完成",
        .diagnosticsQuickStartTitle: "快速上手（3 步）",
        .diagnosticsQuickStartNotificationsTitle: "通知權限",
        .diagnosticsQuickStartNotificationsDetail: "建議先開啟系統通知，提醒會更穩定。",
        .diagnosticsQuickStartGatewayTitle: "AI 連通性",
        .diagnosticsQuickStartGatewayDetail: "點擊「重新檢查」，確認 Gateway 可用。",
        .diagnosticsQuickStartPetModeTitle: "寵物顯示模式",
        .diagnosticsQuickStartPetModeDetail: "可在設定中選擇「僅在提醒時顯示貓咪」。",
        .diagnosticsStatusPass: "通過",
        .diagnosticsStatusWarning: "警告",
        .diagnosticsStatusFailed: "失敗",
        .diagnosticsCheckHelper: "內建 Helper",
        .diagnosticsCheckGateway: "Gateway 位址",
        .diagnosticsCheckMicrophone: "麥克風權限",
        .diagnosticsCheckWhisperCommand: "Whisper 指令",
        .diagnosticsCheckWhisperModel: "Whisper 模型",
        .diagnosticsCheckCosyScript: "CosyVoice 腳本",
        .diagnosticsCheckPythonDependencies: "Python 語音依賴",
    ...
    private static let enTable: [AppStringKey: String] = [
        ...
        .diagnosticsGuideTitle: "First-Run Diagnostics",
        .diagnosticsGuideSubtitle: "Check whether your local environment is ready for assistant and voice features.",
        ...
        .diagnosticsGuideDone: "Done",
        .diagnosticsQuickStartTitle: "Quick Start (3 Steps)",
        .diagnosticsQuickStartNotificationsTitle: "Notifications Permission",
        .diagnosticsQuickStartNotificationsDetail: "Enable system notifications first for more reliable reminders.",
        .diagnosticsQuickStartGatewayTitle: "AI Connectivity",
        .diagnosticsQuickStartGatewayDetail: "Click \"Run Again\" to verify Gateway connectivity.",
        .diagnosticsQuickStartPetModeTitle: "Pet Display Mode",
        .diagnosticsQuickStartPetModeDetail: "In settings, you can choose \"Show cat only for active reminders\".",
        .diagnosticsStatusPass: "Pass",
        .diagnosticsStatusWarning: "Warning",
        .diagnosticsStatusFailed: "Failed",
        .diagnosticsCheckHelper: "Bundled Helper",
        .diagnosticsCheckGateway: "Gateway URL",
        .diagnosticsCheckMicrophone: "Microphone Permission",
        .diagnosticsCheckWhisperCommand: "Whisper Command",
        .diagnosticsCheckWhisperModel: "Whisper Model",
        .diagnosticsCheckCosyScript: "CosyVoice Script",
        .diagnosticsCheckPythonDependencies: "Python Voice Dependencies",
    ...
    private static let jaTable: [AppStringKey: String] = [
        ...
        .diagnosticsGuideTitle: "初回起動診断",
        .diagnosticsGuideSubtitle: "AI アシスタントと音声機能の実行環境をチェックします。",
        ...
        .diagnosticsGuideDone: "完了",
        .diagnosticsQuickStartTitle: "クイックスタート（3 ステップ）",
        .diagnosticsQuickStartNotificationsTitle: "通知の権限",
        .diagnosticsQuickStartNotificationsDetail: "先にシステム通知を有効にすると、リマインダーが安定します。",
        .diagnosticsQuickStartGatewayTitle: "AI 接続性",
        .diagnosticsQuickStartGatewayDetail: "「再チェック」を押して Gateway 接続を確認してください。",
        .diagnosticsQuickStartPetModeTitle: "猫の表示モード",
        .diagnosticsQuickStartPetModeDetail: "設定で「リマインダー時のみ猫を自動表示」を選べます。",
        .diagnosticsStatusPass: "正常",
        .diagnosticsStatusWarning: "警告",
        .diagnosticsStatusFailed: "失敗",
        .diagnosticsCheckHelper: "同梱 Helper",
        .diagnosticsCheckGateway: "Gateway URL",
        .diagnosticsCheckMicrophone: "マイク権限",
        .diagnosticsCheckWhisperCommand: "Whisper コマンド",
        .diagnosticsCheckWhisperModel: "Whisper モデル",
        .diagnosticsCheckCosyScript: "CosyVoice スクリプト",
        .diagnosticsCheckPythonDependencies: "Python 音声依存",
